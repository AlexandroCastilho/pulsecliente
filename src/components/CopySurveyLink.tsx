  ...
  return (
    <div className="relative group inline-block">
      ...
      >
        ...
        {copied && <span className="text-[11px] font-bold pr-1">COPIADO!</span>}
      </button>
      ...
      {!isRespondido && !copied && (
        <div className="absolute bottom-full right-0 mb-2 px-3 py-1.5 bg-indigo-600 text-white text-[11px] font-black uppercase tracking-widest rounded-lg whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none shadow-xl z-30">
          Gerar Link Manual
